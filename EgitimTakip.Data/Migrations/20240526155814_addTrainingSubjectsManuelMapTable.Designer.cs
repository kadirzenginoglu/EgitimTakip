...
namespace EgitimTakip.Data.Migrations
{
    ...
    [Migration("20240526155814_addTrainingSubjectsManuelMapTable")]
    partial class addTrainingSubjectsManuelMapTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EgitimTakip.Models.TrainingsSubjectsMap", b =>
                {
                    ...
                    b.Property<int>("TrainingSubjectsId")
                        .HasColumnType("int");

                    b.Property<int>("Duration")
                        .HasColumnType("int");

                    b.HasKey("TrainingId", "TrainingSubjectsId");

                    b.HasIndex("TrainingSubjectsId");
            ...
            modelBuilder.Entity("EgitimTakip.Models.TrainingsSubjectsMap", b =>
                {
                    b.HasOne("EgitimTakip.Models.Training", "Training")
                        .WithMany("TrainingsSubjectsMaps")
                        .HasForeignKey("TrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EgitimTakip.Models.TrainingSubjects", "TrainingSubjects")
                        .WithMany("TrainingsSubjectsMaps")
                        .HasForeignKey("TrainingSubjectsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EgitimTakip.Models.Training", b =>
                {
                    b.Navigation("TrainingsSubjectsMaps");
                });
